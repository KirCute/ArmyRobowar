...
public static class Events {
    ...
    public const byte M_VIEW_SCREEN = 46;   //UI：玩家查看画面
    public const byte M_VIEW_ROBOT = 47;
    public const byte M_PURCHASE = 48;
    public const byte M_PLAYER_READY = 49;
    public const byte M_CANCEL_READY = 50;
    public const byte M_CHANGE_TEAM = 51;
    public const byte M_LEAVE_MATCHING = 52;
