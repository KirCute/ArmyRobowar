...
namespace System {
    public static class Constants {
        public static readonly IReadOnlyDictionary<string, Technic> TECHNOLOGY = new Dictionary<string, Technic> {
            {"iRobot", new Technic("基础底盘", "只含有两个装备槽", 0.0, _ => { })},
            {"iiRobot", new Technic("进阶底盘", "拥有三个装备槽", 2.0, team => team.availableRobotTemplates.Add("iiRobot"))},
            {"iiiRobot", new Technic("进阶底盘", "拥有三个装备槽", 5.0, team => team.availableRobotTemplates.Add("iiiRobot"))},
            {"BaseCamera", new Technic("基础摄像机", "", 0.0, _ => { })},
            {"BaseGun", new Technic("基础炮", "", 0.0, _ => { })}
        };
        ...
        public static readonly IReadOnlyDictionary<string, TowerTemplate> TOWER_TEMPLATES =
            new Dictionary<string, TowerTemplate> {
                {"BaseTower", new TowerTemplate("BaseTower", "Tower", 45, 2)}
            };
