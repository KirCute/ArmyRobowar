...
namespace System {
    public static class Constants {
        ...
        public static readonly IReadOnlyDictionary<string, Technic> TECHNOLOGY = new Dictionary<string, Technic> {
            ...
            {"iArmor", new Technic("小型装甲", "机器人的最大血量+5。", 2.0, team => team.availableSensorTemplates.Add("iArmor"))},
            {"iiArmor", new Technic("中型装甲", "机器人的最大血量+10。", 3.0, team => team.availableSensorTemplates.Add("iiArmor"))},
            {"iiiArmor", new Technic("大型装甲", "机器人的最大血量+15。", 5.0, team => team.availableSensorTemplates.Add("iiiArmor"))},
            {"iLidar", new Technic("近程雷达", "提供近距离小地图，且机器人扫描过的地方将被记录进团队地图。", 2.0, team => team.availableSensorTemplates.Add("iLidar"))},
            {"iiLidar", new Technic("中程雷达", "提供中等距离小地图，扫描距离增大。", 3.0, team => team.availableSensorTemplates.Add("iiLidar"))},
